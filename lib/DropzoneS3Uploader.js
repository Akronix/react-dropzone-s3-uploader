...
var DropzoneS3Uploader = (function (_React$Component) {
  ...
  function DropzoneS3Uploader() {
    ...
    this.handleDrop = function (files, rejectedFiles) {
      ...
      if (_this.props.preprocess) options.preprocess = _this.props.preprocess;
  ...
  DropzoneS3Uploader.prototype.render = function render() {
    ...
    var hideErrorMessage = this.props.hideErrorMessage || false;
    ...
    return _react2['default'].createElement(
      ...
      error && !hideErrorMessage ? _react2['default'].createElement(
        'small',
        null,
        error
      ) : null
  ...
  _createClass(DropzoneS3Uploader, null, [{
    ...
    value: {
      ...
      hideErrorMessage: _react.PropTypes.bool
    },
    enumerable: true
  }, {
    key: 'defaultProps',
